...
import Forgetpassword from './Pages/ForgetPassword/Forgetpassword'
import ResetPassword from './Pages/ForgetPassword/ResetPassword'
import { Toaster } from 'react-hot-toast' // Ensure this is only imported once
import ResetTeacher from './Pages/ForgetPassword/ResetTeacher'
import Course from './Pages/Components/Admin/Course'
import axios from 'axios'; // Import axios

// Configure axios globally to send cookies with all requests
axios.defaults.withCredentials = true; // This will include cookies with all axios requests
