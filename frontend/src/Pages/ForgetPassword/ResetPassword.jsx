...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response= axios.post(`https://learning-plat-36hz.vercel.app/student/forgetpassword/${token}`,{password:data.password,confirmPassword:data.confirmPassword})
