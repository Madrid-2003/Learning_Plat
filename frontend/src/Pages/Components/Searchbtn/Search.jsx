...
  // MODIFIED handleEnroll function for PayU
  const handleEnroll = async (courseName, id) => {
    try {
...
      const { txnid, hash, key, SURL, FURL, productinfo, firstname, email, phone } = payuResponse.data.data;

      // Step 3: Dynamically create and submit a form to the PayU gateway
      const payuForm = document.createElement('form');
      payuForm.action = 'https://test.payu.in/_payment'; // Use this for testing
      // For production, use 'https://secure.payu.in/_payment'
      payuForm.method = 'post';
      payuForm.style.display = 'none';

      // Append necessary inputs to the form
      const params = {
        key,
        txnid,
        hash,
...
        email,
        phone,
        surl: SURL, // Success URL (your frontend route)
        furl: FURL, // Failure URL (your frontend route)
      };
