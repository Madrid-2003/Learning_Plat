...
const Admin = () => {
  ...
  useEffect(()=>{
    const getAllMsg = async () => {
      try {
        const response = await fetch(`https://learning-plat-36hz.vercel.app/admin/messages/all`, {
          method: "GET",
          headers: {
  ...
  const Approval = async(ID, type, approve)=>{
    try {
      ...
      const response = await fetch(`https://learning-plat-36hz.vercel.app/admin/${adminID}/approve/${type}/${ID}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
        },
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await fetch(`https://learning-plat-36hz.vercel.app/admin/${data}/approve`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
