...
const Course = () => {
  ...
  useEffect(() => {
    const fetchCourseRequests = async () => {
      try {
        const response = await axios.get(`https://learning-plat-36hz.vercel.app/admin/${data}/approve/course`);
  ...
  //   console.log(id);
  //   try {
  //     const response = await fetch(`https://learning-plat-36hz.vercel.app/admin/${data}/approve/course/${id}`, {
  //       method: 'POST',
  //       headers: {
  ...
  const handleAccept = async (id, info) => {
    ...
    try {
      const response = await axios.post(`https://learning-plat-36hz.vercel.app/admin/${data}/approve/course/${id}`, {
        Isapproved: true,
        email: info.Email,
        Firstname: info.enrolledteacher,
      }, {
