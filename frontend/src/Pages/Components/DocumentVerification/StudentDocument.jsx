...
const StudentDocument = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await fetch(`https://learning-plat-36hz.vercel.app/student/StudentDocument/${Data}`, {
          method: "GET",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://learning-plat-36hz.vercel.app/student/verification/${Data}`, {
        method: "POST",
        body: formDataObj,
      });
