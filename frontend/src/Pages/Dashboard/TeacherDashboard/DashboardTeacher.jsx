...
function DashboardTeacher() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await fetch(`https://learning-plat-36hz.vercel.app/Teacher/TeacherDocument/${ID}`, {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const getAmount = async () => {
      try {
        const response = await fetch(`https://learning-plat-36hz.vercel.app/payment/teacher/${ID}/balance`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
